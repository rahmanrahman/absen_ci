 <footer class="footer">
    ...
    <script src="<?php echo base_url('assets/dist')?>/js/loading-bar.min.js"></script>
    ...
    <script>
      ...
      // ===== loadingBar
      const ldBar1 = new ldBar("#ldBar-1", {
        preset: "circle",
        value: 100,
      });
      // ===== loadingBar
      const ldBar2 = new ldBar("#ldBar-2", {
        preset: "circle",
        value: 80,
      });
      // ===== loadingBar
      const ldBar3 = new ldBar("#ldBar-3", {
        preset: "circle",
        value: 50,
      });
      // ===== loadingBar
      const ldBar4 = new ldBar("#ldBar-4", {
        preset: "circle",
        value: 60,
      });
      // ===== loadingBar
      const ldBar5 = new ldBar("#ldBar-5", {
        preset: "circle",
        value: 20,
      });
      // ===== loadingBar
      const ldBar6 = new ldBar("#ldBar-6", {
        preset: "circle",
        value: 10,
      });
      // ===== loadingBar
      const ldBar7 = new ldBar("#ldBar-7", {
        preset: "circle",
        value: 65,
      });

            // ===== loadingBar
      const ldBar8 = new ldBar("#ldBar-8", {
        preset: "circle",
        value: 65,
      });
...
<!-- Mirrored from demo.plainadmin.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Aug 2022 04:19:13 GMT -->
</html>
