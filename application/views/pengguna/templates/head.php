  ...
  <body>
    ...
    <aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="<?php echo base_url().'C_pengguna/index';?>">
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse dropdown-nav">
              <li>
                <a href="<?php echo base_url('C_pengguna/Absen')?>"> Absen </a>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li>
                <a href="<?php echo base_url('C_pengguna/Laporan_Absen')?>"> Laporan Absen </a>
              </li>
            </ul>
          </li>
            ...
            <div class="col-lg-7 col-md-7 col-6">
              <div class="header-right">
                ...
                <div class="profile-box ml-15">
                  ...
                  >
                    <li>
                      <a href="<?php echo base_url('C_pengguna/Profil')?>">
                        <i class="lni lni-user"></i> View Profile
                      </a>
                    </li>
                    <li>
                      <a href="<?php echo base_url('C_pengguna/Edit_Profil')?>"> <i class="lni lni-cog"></i> Settings </a>
                    </li>
                    <li>
